...
class GaussianDiffusion1D(Module):
    def __init__(
        ...
        self.seq_length = num_numerical_features + num_cat_features
        ...
        self.normalize = identity #normalize_to_neg_one_to_one if auto_normalize else identity
        self.unnormalize = identity #unnormalize_to_zero_to_one if auto_normalize else identity
    ...
    def model_predictions(self, x, t, x_self_cond = None, clip_x_start = False, rederive_pred_noise = False):
        ...
        maybe_clip = identity#partial(torch.clamp, min = -1., max = 1.) if clip_x_start else identity
    ...
    def sample_all(self, batch_size, ignore, y_dist = None, ddim=None): 
        return self.sample(batch_size).detach().cpu()
...
class Trainer1D(object):
    def __init__(
        ...
        *,
        ...
        self.results_folder = Path('./models/')
            ...
            while self.step < self.train_num_steps:
                ...
                if (self.step + 1) % self.log_every == 0:
                    ...
                    if (self.step + 1) % self.print_every == 0:
                        print(f'Step {(self.step + 1)}/{self.train_num_steps} MLoss: {mloss} GLoss: {gloss} Sum: {mloss + gloss}')
                    wandb.log({
                        "gloss": gloss,
                        "mloss": mloss,
                    })
